...
public class CreateVarValidator extends ElementValidator {

    private static final Logger LOGGER = LogManager.getLogger(Main.class.getName());

    public CreateVarValidator(AssertionUDA uda) {
        super(uda);
    }
    ...
    public AssertionUDA validate(String domName) {
        ...
        try {
            ...
            if (udaPageSourceElment != null) {
                ...
                uda.getResult().setValue("" + this.uda.getValue());
            }
            return uda;
        } catch (IOException e) {
